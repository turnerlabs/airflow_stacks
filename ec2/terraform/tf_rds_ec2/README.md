...
You will need to update the terraform / backend / bucket in the main.tf in tf_rds_ec2 to use this terraform state bucket.
...
The Airflow server will be able to communicate with the RDS server.
