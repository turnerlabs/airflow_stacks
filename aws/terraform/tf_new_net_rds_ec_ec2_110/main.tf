...
resource "aws_wafregional_rule" "airflow_waf_rule" {
  depends_on  = ["aws_wafregional_ipset.airflow_waf_ipset"]
...
resource "aws_wafregional_web_acl" "airflow_waf_web_acl" {
  depends_on  = ["aws_wafregional_rule.airflow_waf_rule"]
...
resource "aws_wafregional_web_acl_association" "airflow_waf_web_acl_assoc" {
  depends_on    = ["aws_lb.airflow_lb", "aws_wafregional_web_acl.airflow_waf_web_acl"]
...
# Airflow Worker Scale Up / Scale Down policies
